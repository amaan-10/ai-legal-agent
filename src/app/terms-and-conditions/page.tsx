        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              className="flex flex-col flex-none place-content-start items-start gap-0 h-min overflow-hidden p-0 relative w-full"
              data-framer-name="Content"
            >
              <div
                className="outline-none flex flex-col justify-start opacity-100 shrink-0 will-change-transform flex-none h-auto relative whitespace-pre-wrap w-full break-words"
                data-framer-appear-id="1sh1iqv"
                data-framer-component-type="RichTextContainer"
              >
                <p
                ...
                <p
                  className="text-base font-normal text-[#616161] mt-5"
                  data-styles-preset="y6TpHoXJq"
                >
                  By accessing and using Nyāyik, you agree to be bound by these
                  Terms and Conditions. Please read them carefully, as they
                  govern your access to and use of our legal advisory tools and
                  features.
                </p>
                <p
                ...
                <p
                  ...
                  data-styles-preset="y6TpHoXJq"
                >
                  Nyāyik offers AI-driven legal assistance, including document
                  analysis, legal insights, and regulatory updates. We may
                  update, enhance, suspend, or discontinue any part of the
                ...
                <p
                  ...
                  data-styles-preset="y6TpHoXJq"
                >
                  You agree to use Nyāyik only for lawful purposes. Misuse of
                  the platform—such as submitting unlawful, harmful, misleading,
                  or offensive content—is strictly prohibited. You must not
                  infringe on the rights of others or violate any laws while
                  using our services.
                </p>
                <p
                  className="text-[20px] md:text-[22px] lg:text-2xl font-semibold text-[#111111] font-urbanist mt-10"
                ...
                <p
                  ...
                  data-styles-preset="y6TpHoXJq"
                >
                  All content, including legal analyses, design elements, and
                  branding on Nyāyik, is protected by intellectual property
                  laws. You may not reproduce, distribute, or use any of our
                ...
                <p
                  ...
                  data-styles-preset="y6TpHoXJq"
                >
                  While Nyāyik strives to provide accurate and helpful legal
                  guidance, it does not constitute formal legal advice. We are
                  not liable for any outcomes, damages, or losses resulting from
                  the use—or inability to use—our platform. Always consult a
                ...
                >
                  ...
                  any time. Revisions will take effect immediately upon posting
                  on this page. Continued use of Nyāyik after changes means you
                ...
                >
                  ...
                  <Link
                    href="support@nyayik.ai"
                    className="text-[#616161] hover:text-[#111111] hover:underline"
                  >
                    support@nyayik.ai
                  </Link>
                </p>
